...
<!--  内容列表   -->
<form name="form2" action="${pageContext.request.contextPath}/userServletSave" method="post">
...
<input type="submit" value="新增员工" style="float: right;"/>
</form>
