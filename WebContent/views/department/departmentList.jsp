...
<tr>
 <td height="26" background="images/newlinebg3.gif">
  ...
  <td align="right">
    ...
    <a href="${pageContext.request.contextPath}/departmentServletAdd">添加部门</a>
 </td>
 </tr>
</table>
</td>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><a href=''><u>${department.departmentname}</u></a></td>
	<td>${department.managerid}</td>
	
	<td>
	 <a href="${pageContext.request.contextPath}/departmentServletUp?toid=${department.toid}">编辑</a> | 
	 <a href="101">预览</a> |
	 <a href="${pageContext.request.contextPath}/departmentServletDel?toid=${department.toid}">删除</a>
	 </td>
</tr>
</c:forEach>
